        ...
        <div className="container-fluid px-4">
            <div className="card mt-4">
                <div className="card-header">
                    <h4>Add Category
                        <Link to="/admin/view-category" className="btn btn-dark btn-sm float-end">Add Category</Link>
                    </h4>
                </div>
                <form onSubmit={submitCategory} id="CATEGORY_FORM">
                    ...
                    <button type="submit" className="btn btn-dark px-4 mt-3">Submit</button>
                </form>
            </div>
        </div>
    );
